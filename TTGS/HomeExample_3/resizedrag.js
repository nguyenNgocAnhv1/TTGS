...
resizedrag(document.querySelector("#p_chart_1"), document.querySelector("#p_chart_1"), onStart, onEnd);
resizedrag(document.querySelector("#p_chart_2"), document.querySelector("#p_chart_2"), onStart, onEnd);
resizedrag(document.querySelector("#p_chart_3"), document.querySelector("#p_chart_3"), onStart, onEnd);
resizedrag(document.querySelector("#p_chart_5"), document.querySelector("#p_chart_5"), onStart, onEnd);
